...
In our department H3K27ac ChipSeq data was produced for several neuroblastoma samples. 
* Click on the button **Load/Store Profile** in the top right corner, click **Execute** and click **Goto the GenomeBrowser** to view the ChipSeq data generated by our department on chromosome 11 at the translocation site of the TERT gene.
* Now go back to TERT by typing the gene name into the textfield at **Find gene** in the top left corner. You can zoom out a bit to have a better overview of methylation profiles at the TERT gene location. 

 ---------
  ![](_static/images/R2d2_logo.png)**How is the H3K27ac ChipSeq data related to the information about superenhancers?**
