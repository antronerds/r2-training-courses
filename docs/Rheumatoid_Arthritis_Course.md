...
Investigating samples of patients with rheumatoid arthritis
=================================
...
------------
<!-- ToDo --> 
Introduction about genomics and rheumatoid arthritis.
...
* Exp Rheumatoid arthritis tocilizumab - Takeshita - 22 - deseq2_rlog - gse113156:  
 22 whole CD4+ and CD8+ T cells from frozen PBMC samples that were collected before and after treatment initiation of 11 patients with rheumatoid arthritis  
...
A graph shows the expression of this gene's mRNA in the whole set of childhood tumor cell lines. Samples are along the x-axis, mRNA expression values of the gene in a sample are on the y-axis. Below the graph is the available annotation for the samples shown in colored tracks. 
  ...
  * Now try the gene XX (Click the **Go to Main** link in the left upper corner)
